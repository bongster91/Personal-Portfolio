...
function BioBackground() {
    return (
        <Background>
            ...
            <p>This portfolio is an upgraded version of the <a href="https://codepen.io/bongster91/pen/VwaWmLz">mini site</a> that I submitted as a part of the Pursuit application. I think this portfolio is an effective and accurate measurement of the skills and knowledge I obtained since then. How memorable it would be if my portfolio launches my tech career the way the mini site got me into Pursuit.</p>
        </Background>
    );
};
